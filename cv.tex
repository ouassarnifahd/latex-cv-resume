...
\begin{column}[\leftcolumnwidth]
	...
	\addblock{\faBriefcase}{Exp\'eriences professionnelles}
		...
		\addcontent[job]{Stagiaire}
			...
			{
				\squareitem{
					Developpement de logiciel embarqu\'e.
				}
				\squareitem{
					Conception de circuit imprim\'e.
				}
				\squareitem{
					Synth\`ese FPGA Xilinx.
				}
			}
	...
	\addblock{\faWrench}{Projets professionnels}
		...
		\addcontent[project]{Xen on ARM}
			...
			{
				\squareitem{
					Introduction \`a la virtualisation pour les syst\`emes embarqu\'es avec Xen.
				}
			}
